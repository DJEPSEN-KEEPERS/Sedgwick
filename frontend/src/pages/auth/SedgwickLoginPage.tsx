    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary-900 p-12 text-white">
        <div>
          ...
          <p className="mt-4 text-lg text-white/70 font-body">
            Intern administration af skadesager og entrepriser
          </p>
        </div>

        <div className="space-y-4">
          {[
            { label: 'Aktive sager', value: '~100' },
            { label: 'Håndværkervirksomheder', value: '50+' },
            { label: 'Forsikringsselskaber', value: '12' },
          ].map(({ label, value }) => (
      ...
      <div className="flex flex-1 flex-col items-center justify-center p-6 bg-[#f4f6f9]">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-display font-bold text-gray-900">Medarbejder login</h2>
            <p className="mt-1 text-sm text-gray-500">Sedgwick intern portal</p>
          </div>

          <div className="bg-white rounded-xl shadow-card border border-[#e5e7eb] p-6">
            <LoginForm portalLabel="Medarbejder" />
          </div>

          <p className="mt-6 text-center text-xs text-gray-400">
            Problemer med login? Kontakt IT-support
          </p>
        </div>
      </div>
    </div>
